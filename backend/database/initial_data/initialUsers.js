...
const Gnder = require('../../../enums.js').Gender;
...
{tenant: 'Tenant.UGA', fname: 'matt', lname: 'peterson', gender: Gender.MALE, role: UserRole.MANAGER, email: 'Matt@gmail.com', preferred_shifts: 3, availability: [], 'shift_types': []},
{tenant: 'Tenant.UGA', fname: 'john', lname: 'crumbley', gender: Gender.MALE, role: UserRole.MANAGER, email: 'John@gmail.com', preferred_shifts: 3, availability: [], 'shift_types': []},
{tenant: 'Tenant.UGA', fname: 'nathan', lname: 'toburen', gender: Gender.MALE, role: UserRole.ADMIN, email: 'Nathan@gmail.com', preferred_shifts: 3, availability: [], 'shift_types': []},
{tenant: 'Tenant.UGA', fname: 'jackson', lname: 'jones', gender: Gender.MALE, role: UserRole.MANAGER, email: 'Jackson@gmail.com', preferred_shifts: 3, availability: [], 'shift_types': []},
...
{tenant: 'Tenant.UGA', fname: 'brooke', lname: 'unknown', gender: Gender.FEMALE, role: UserRole.BASIC, email: 'Brooke@gmail.com', preferred_shifts: 3, availability: [], 'shift_types': [ShiftType.SHOP, ShiftType.CARTS, ShiftType.RANGE, ShiftType.RANGE_REGISTER]},
...
{tenant: 'Tenant.UGA', fname: 'jeff', lname: 'unknown', gender: Gender.MALE, role: UserRole.BASIC, email: 'Jeff@gmail.com', preferred_shifts: 3, availability: [], 'shift_types': [ShiftType.STARTER]},
...
{tenant: 'Tenant.UGA', fname: 'ron', lname: 'unknown', gender: Gender.MALE, role: UserRole.BASIC, email: 'Ron@gmail.com', preferred_shifts: 3, availability: [], 'shift_types': [ShiftType.STARTER]},
{tenant: 'Tenant.UGA', fname: 'mike', lname: 'c', gender: Gender.MALE, role: UserRole.BASIC, email: 'MikeC@gmail.com', preferred_shifts: 3, availability: [], 'shift_types': [ShiftType.STARTER]},
...
{tenant: 'Tenant.UGA', fname: 'steve', lname: 'unknown', gender: Gender.MALE, role: UserRole.BASIC, email: 'Steve@gmail.com', preferred_shifts: 3, availability: [], 'shift_types': [ShiftType.STARTER]},
{tenant: 'Tenant.UGA', fname: 'clint', lname: 'udell', gender: Gender.MALE, role: UserRole.MANAGER, email: 'Clint@gmail.com', preferred_shifts: 3, availability: [], 'shift_types': []},
...
{tenant: 'Tenant.UGA', fname: 'Nathan', lname: 'a', gender: Gender.MALE, role: UserRole.BASIC, email: 'NathanA@gmail.com', preferred_shifts: 3, availability: [], 'shift_types': [ShiftType.CARTS, ShiftType.RANGE, ShiftType.RANGE_REGISTER]},
...
{tenant: 'Tenant.UGA', fname: 'avery', lname: 'unknown', gender: Gender.FEMALE, role: UserRole.BASIC, email: 'Avery@gmail.com', preferred_shifts: 3, availability: [], 'shift_types': [ShiftType.CARTS, ShiftType.RANGE, ShiftType.RANGE_REGISTER]},
